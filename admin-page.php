...
<head>
    ...
    <title>Abid Rafiq Quran Academy - Admin</title>
    <!-- ======= Styles ====== -->
...
<!-- =============== Delete center modal ================ -->
    <div
      data-te-modal-init
      class="fixed left-0 top-0 z-[1055] hidden h-full w-full overflow-y-auto overflow-x-hidden outline-none"
      id="deleteCenterModal"
      tabindex="-1"
      aria-labelledby="deleteCenterModalTitle"
      aria-modal="true"
      role="dialog"
    >
      <div
      ...
      >
        ...
        >
          ...
          >
            ...
            <button
              type="button"
              class="close box-content rounded-none border-none hover:no-underline hover:opacity-75 focus:opacity-100 focus:shadow-none focus:outline-none"
              data-te-modal-dismiss
              aria-label="Close"
            >
              <svg
          ...
          <div class="relative p-4 flex justify-center">
            <p class="font-extrabold">هل انت متاكد من حذف المركز ؟</p>
          </div>
...
<!-- =============== update center modal ================ -->
    <div
      data-te-modal-init
      class="fixed left-0 top-0 z-[1055] hidden h-full w-full overflow-y-auto overflow-x-hidden outline-none"
      id="updateCenterModal"
      tabindex="-1"
      aria-labelledby="updateCenterModalLabel"
      aria-hidden="true"
    >
      <div
        data-te-modal-dialog-ref
      ...
      >
        ...
        >
          ...
          <div
            class="block rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700"
          >
            <form onsubmit="handleUpdateCenter(this)">
              <!--address input-->
              <div
                class="mb-2 font-bold text-2xl bg-gray-200 text-primary flex justify-center"
              >
              ...
              <div class="relative mb-6">
                <select name="workingDays" data-te-select-init required>
                  <option value="1">احد - ثلاثاء - خميس</option>
                  <option value="2">سبت - اثنين - اربعاء</option>
                </select>
                <label data-te-select-label-ref>ايام الدوام</label>
              </div>
              <!--Submit button-->
              <button
                type
        ...
        <ul>
            <li>
                <a class="mt-2"> 
                    ...
                    <span style="font-size: xx-large" class="title">أكاديمية عابد رفيق للقرآن</span>
                </a>
            </li>
